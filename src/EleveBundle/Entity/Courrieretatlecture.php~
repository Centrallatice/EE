 ...
 * @ORM\Entity(repositoryClass="EleveBundle\Repository\CourrieretatlectureRepository")
 */
class Courrieretatlecture
{
    ...
    * @ORM\JoinColumn(name="numOrdre", referencedColumnName="Commandes_NoOrdre", nullable=false)
     ...
     * Set codecourrier
     *
     * @param \EleveBundle\Entity\Courriertype $codecourrier
     *
     * @return Courrieretatlecture
     */
    public function setCodecourrier(\EleveBundle\Entity\Courriertype $codecourrier)
    {
     ...
     * Get codecourrier
     *
     * @return \EleveBundle\Entity\Courriertype
     */
