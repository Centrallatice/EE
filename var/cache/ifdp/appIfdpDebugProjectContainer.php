...
/**
 * appIfdpDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appIfdpDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'services.filtre_marque' => 'getServices_FiltreMarqueService',
    ...
    {
        return $this->services['app.form_login_authenticator'] = new \EleveBundle\Security\FormLoginAuthenticator($this->get('router'), $this->get('security.password_encoder'), $this);
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nTxaL+6pHz', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xTt0DEA3hl', 0, 'WRurNdKl9wbY+stuTAFXrN', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('main' => 'doctrine.dbal.main_connection'), array('main' => 'doctrine.orm.main_entity_manager'), 'main', 'main');
    }
    ...
    protected function getDoctrine_Dbal_MainConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.main_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => '192.168.0.35\\bestiole', 'dbname' => 'EE', 'user' => 'sa', 'password' => 'cu0707_TMSC', 'charset' => 'UTF-8', 'port' => NULL, 'driverOptions' => array(1002 => 'SET NAMES \'UTF8\''), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_MainEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\EleveBundle\\Entity'))), 'EleveBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_MainMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_main_5ec74fdf0c0ecbb8fdd4c290924863e359a49ce1f539958ee0b27e65a9fbd38c');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('SPCz2WjQR8', NULL, 'WRurNdKl9wbY+stuTAFXrN', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('EleveBundle\\Entity\\Eleve' => $this->get('integer_encoder'), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/eleve');
    ...
    /**
     * Gets the 'services.filtre_marque' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EleveBundle\Service\FilterByMarqueService A EleveBundle\Service\FilterByMarqueService instance
     */
    protected function getServices_FiltreMarqueService()
    {
        return $this->services['services.filtre_marque'] = new \EleveBundle\Service\FilterByMarqueService($this->get('doctrine.orm.main_entity_manager'), $this);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[3].'\\app/../var/sessions/ifdp'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 'resources' => 'materialize_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-hL5459frD', 0, 'WRurNdKl9wbY+stuTAFXrN', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'EleveBundle\\Entity\\Eleve', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.save_path': $value = ($this->targetDirs[3].'\\app/../var/sessions/ifdp'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appIfdpDebugProjectContainer',
            'database_host' => '192.168.0.35\\bestiole',
            'database_port' => 1433,
            'database_name' => 'EE',
            'database_user' => 'sa',
            ...
            'debug.container.dump' => (__DIR__.'/appIfdpDebugProjectContainer.xml'),
            ...
            'router.options.matcher.cache_class' => 'appIfdpDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'appIfdpDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => (__DIR__.'/assetic/routing.yml'),
            'router.cache_class_prefix' => 'appIfdpDebugProjectContainer',
