...
/**
 * appCultureDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appCultureDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'services.eleves' => 'getServices_ElevesService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UKnoPUohPR', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WbzUft92hB', 0, 'GerMUZjD0P-nCe8e+s2R8f', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_CultureFormationMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_culture_formation_b5223f2dfe6c28ec9803f9a53dfe9117de38af87cf8c6b6a06309904bb4094f7');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DatasFrMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_datas_fr_b5223f2dfe6c28ec9803f9a53dfe9117de38af87cf8c6b6a06309904bb4094f7');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_IconetMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_iconet_b5223f2dfe6c28ec9803f9a53dfe9117de38af87cf8c6b6a06309904bb4094f7');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('gWXEcDMnUG', NULL, 'GerMUZjD0P-nCe8e+s2R8f', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    /**
     * Gets the 'services.eleves' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EleveBundle\Service\EleveService A EleveBundle\Service\EleveService instance
     */
    protected function getServices_ElevesService()
    {
        return $this->services['services.eleves'] = new \EleveBundle\Service\EleveService($this, $this->get('security.token_storage'));
    }
    ...
    {
        return $this->services['services.messagerie'] = new \EleveBundle\Service\MessagerieService($this, $this->get('security.token_storage'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[3].'\\app/../var/sessions/culture'));
    }
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController($this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL, $this->get('twig'), array(), 'bottom', ${($_ = isset($this->services['web_profiler.csp.handler']) ? $this->services['web_profiler.csp.handler'] : $this->getWebProfiler_Csp_HandlerService()) && false ?: '_'}, $this->targetDirs[3]);
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NZlug28jF7', 0, 'GerMUZjD0P-nCe8e+s2R8f', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.save_path': $value = ($this->targetDirs[3].'\\app/../var/sessions/culture'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appCultureDebugProjectContainer',
            ...
            'debug.container.dump' => (__DIR__.'/appCultureDebugProjectContainer.xml'),
            ...
            'router.options.matcher.cache_class' => 'appCultureDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'appCultureDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => (__DIR__.'/assetic/routing.yml'),
            'router.cache_class_prefix' => 'appCultureDebugProjectContainer',
